...
public class FakeDataTmdb {
    ...
    public static MovieDetail generateDetailMovieData(MovieDetail movieDetail, boolean favorite){
        movieDetail.setFavorite(favorite);
        movieDetail = generateDetailMovie(String.valueOf(movieDetail.getId()));
        return movieDetail;
    }

    public static TvShowDetail generateDetailTvData(TvShowDetail tvShowDetail, boolean favorite){
        tvShowDetail.setFavorite(favorite);
        tvShowDetail = genereateDetailTv(tvShowDetail.getId());
        return tvShowDetail;
    }


    public static ArrayList<MovieModel> generateMovieData(){
        ArrayList<MovieModel> movie = new ArrayList<>();

        ArrayList<GenreModel> genreModels = new ArrayList<>();


        movie.add(new MovieModel(475557,
                "Joker",
                "8.6",
        ...
        movie.add(new MovieModel(420809,
        ...
        movie.add(new MovieModel(290859,
        ...
        movie.add(new MovieModel(420818,
                "The Lion King",
                "7.6",
        ...
        movie.add(new MovieModel(429617,
    ...
    public static ArrayList<TvShowModel> generateTvData(){

        ArrayList<TvShowModel> tv = new ArrayList<>();

        ArrayList<GenreModel> genreModels = new ArrayList<>();

        tv.add(new TvShowModel(1412,
                "Arrow",
                "5.8",
                "/dKxkwAJfGuznW8Hu0mhaDJtna0n.jpg",
                "/mo0FP1GxOFZT4UDde7RFDz5APXF.jpg",
    ...
    public static MovieDetail generateDetailMovie(String id){
        ...
        if (id.equals("475557")){
            movieDetail = new MovieDetail(idInt,
                    "Joker",
                    "8.6",
                    "/n6bUvigpRFqSwmPp1m2YADdbRBc.jpg",
                    "/udDclJoHjfjb8Ekgsd4FDteOkCU.jpg",
    ...
    public static TvShowDetail genereateDetailTv(int id){
        ArrayList<GenreModel> genreModels = new ArrayList<>();

        TvShowDetail tvShowModel = new TvShowDetail();

        if (id == 1412){
            tvShowModel = new TvShowDetail(1412,
                    "Arrow",
                    "5.8",
                    "/dKxkwAJfGuznW8Hu0mhaDJtna0n.jpg",
                    "/mo0FP1GxOFZT4UDde7RFDz5APXF.jpg",
            ...
            tvShowModel = new TvShowDetail(62286,
                    "Fear the Walking Dead",
                    "6.3",
                    "/7r4FieFH6Eh6S55hi8c9LOiFENg.jpg",
                    "/lZMb3R3e5vqukPbeDMeyYGf2ZNG.jpg",
            ...
            tvShowModel = new TvShowDetail(60735,
                    "The Flash",
                    "6.7",
                    "/jC1KqsFx8ZyqJyQa2Ohi7xgL7XC.jpg",
                    "/wHa6KOJAoNTFLFtp7wguUJKSnju.jpg",
            ...
            tvShowModel = new TvShowDetail(1622,
                    "Supernatural",
                    "7.4",
                    "/o9OKe3M06QMLOzTl3l6GStYtnE9.jpg",
                    "/KoYWXbnYuS3b0GyQPkbuexlVK9.jpg",
            ...
            tvShowModel = new TvShowDetail(69050,
                    "Riverdale",
                    "7.2",
                    "/2IUpoKSP64r6rp2vBo0Fdk8a1UU.jpg",
                    "/4X7o1ssOEvp4BFLim1AZmPNcYbU.jpg",
