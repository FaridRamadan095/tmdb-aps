...
public class TvShowDetail implements Serializable, Parcelable {
    ...
    public TvShowDetail(int id, String name, String vote_average, String backdrop_path, String poster_path, String overview, String first_air_date, Boolean favorite, ArrayList<GenreModel> genreModels) {
        this.id = id;
        this.name = name;
