...
public class MovieDetail implements Serializable, Parcelable{
    ...
    public MovieDetail(int id, String title, String vote_average, String backdrop_path, String poster_path, String overview, String release_date, Boolean favorite, ArrayList<GenreModel> genreModels) {
        this.id = id;
        this.title = title;
